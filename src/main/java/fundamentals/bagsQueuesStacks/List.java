...
public class List<Item> implements Iterable<Item> {
	...
	/*************************************************
	 * Exercise 1.3.28 (recursive variant of Exercise 1.3.27) Type 'Item' must implement interface Comparable
	 *************************************************/
	...
	public Node reverse(Node node) {
		Node srcFirst = node, destFirst = null;
		while (srcFirst != null) {
