...
{
    public static double binomial(int n, int k, double p, fundamentals.dataAbstraction.Counter c)
    {
    ...
    public static void main(String[] args)
    {
        ...
        fundamentals.dataAbstraction.Counter c = new fundamentals.dataAbstraction.Counter("calls");
