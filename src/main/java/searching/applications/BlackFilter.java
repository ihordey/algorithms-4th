...
/*************************************************************************
 *  Compilation:  javac searching.applications.BlackFilter.java
 *  Execution:    java searching.applications.BlackFilter blacklist.txt < input.txt
 ...
 *  was it the of 
 * 
 *  % java searching.applications.BlackFilter list.txt < tinyTale.txt
