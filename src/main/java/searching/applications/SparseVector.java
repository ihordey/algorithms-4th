...
/*************************************************************************
 *  Compilation:  javac searching.applications.SparseVector.java
 *  Execution:    java searching.applications.SparseVector
 *  
...
public class SparseVector {
    ...
    public double dot(SparseVector that) {
        if (this.N != that.N) throw new RuntimeException("fundamentals.dataAbstraction.Vector lengths disagree");
        double sum = 0.0;
