...
/*************************************************************************
 *  Compilation:  javac searching.applications.WhiteFilter.java
 *  Execution:    java searching.applications.WhiteFilter whitelist.txt < input.txt
 ...
 *  was it the of 
 * 
 *  % java searching.applications.WhiteFilter list.txt < tinyTale.txt
